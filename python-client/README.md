...
[![Version](https://img.shields.io/badge/version-1.4.1-green)](./cobranca_api/__init__.py)
...
```python
from cobranca_api import BoletoClient, BoletoValidationError
...
```python
from cobranca_api import BoletoClient
from cobranca_api.models import BoletoData
...
- [Exemplos](../examples/)
- [Repositório GitHub](https://github.com/Maxwbh/cobranca-api)
...
Este cliente consome a **Cobranca-API**, que usa a engine [PyCobrança](https://github.com/Maxwbh/pyCobranca) (100% Python) para gerar boletos, CNAB e Pix.
