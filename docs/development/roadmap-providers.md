...
> que fala com a API do banco. Estado atual: **C6**, **Sicoob** e **Inter**
> validados em sandbox; **18 bancos** via CNAB offline (engine pyCobrança).
...
Efí, Asaas, PagBank e Cielo também oferecem link hospedado e passam no mesmo
