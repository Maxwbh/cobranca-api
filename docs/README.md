...
- [development/servicos-online-por-banco.md](development/servicos-online-por-banco.md) — **Serviços online dos 18 bancos**: quem tem API de boleto registrado e de Pix, um a um
