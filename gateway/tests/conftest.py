...
def make_pfx_base64(password: bytes = b"secret") -> str:
    ...
    # `utcnow()` está deprecado desde o 3.12 (devolvia datetime NAIVE marcado
    # como UTC). Uma leitura só para os dois limites: com duas chamadas a
    # validade não fica exatamente simétrica em torno de agora.
