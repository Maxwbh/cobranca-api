...
from app.routers._params import TENANT as _TENANT
...
def consultar_job(job_id: str, tenant_id: str = _TENANT) -> Any:
...
def listar_itens(job_id: str, tenant_id: str = _TENANT, status: js.StatusItem | None = _STATUS_ITEM,
...
def consultar_item(job_id: str, item_id: str, tenant_id: str = _TENANT) -> Any:
...
def manifesto_artefatos(job_id: str, tenant_id: str = _TENANT) -> Any:
...
def baixar_artefato_item(job_id: str, nome: str, tenant_id: str = _TENANT) -> Any:
...
def baixar_artefato(job_id: str, nome: str, tenant_id: str = _TENANT) -> Any:
...
def consultar_job_remessas(job_id: str, tenant_id: str = _TENANT) -> Any:
...
def listar_arquivos_remessa(job_id: str, tenant_id: str = _TENANT) -> Any:
...
def baixar_arquivo_remessa(job_id: str, nome: str, tenant_id: str = _TENANT) -> Any:
