...
def consultar(external_reference_id: str = _EXT_REF, *, tenant_id: str, provider: Provider = _PROVIDER_ON, banco: Banco | None = _BANCO,
...
def pdf(external_reference_id: str = _EXT_REF, *, tenant_id: str, provider: Provider = _PROVIDER_ON, banco: Banco | None = _BANCO,
        credentials: str | None = _CREDS_HEADER,
        authorization: str | None = _AUTH_HEADER,
        vault: Vault = Depends(get_vault)) -> CobrancaOut:
...
def cancelar(external_reference_id: str = _EXT_REF, *, tenant_id: str, provider: Provider = _PROVIDER_ON, banco: Banco | None = _BANCO,
             credentials: str | None = _CREDS_HEADER,
             authorization: str | None = _AUTH_HEADER,
             vault: Vault = Depends(get_vault)) -> CobrancaOut:
