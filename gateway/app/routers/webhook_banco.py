...
def consultar(tenant_id: str = _TENANT, service: ServicoWebhook = _SERVICE,
...
def remover(tenant_id: str = _TENANT, service: ServicoWebhook = _SERVICE,
            provider: Provider = _PROVIDER_ON, banco: Banco | None = _BANCO,
            credentials: str | None = _CREDS_HEADER,
            authorization: str | None = _AUTH_HEADER,
            vault: Vault = Depends(get_vault)) -> dict:
...
def consultar_pix(tenant_id: str = _TENANT, chave: str = _CHAVE,
                  provider: Provider = _PROVIDER_ON, banco: Banco | None = _BANCO,
                  credentials: str | None = _CREDS_HEADER,
                  authorization: str | None = _AUTH_HEADER,
                  vault: Vault = Depends(get_vault)) -> dict:
...
def remover_pix(tenant_id: str = _TENANT, chave: str = _CHAVE,
                provider: Provider = _PROVIDER_ON, banco: Banco | None = _BANCO,
                credentials: str | None = _CREDS_HEADER,
                authorization: str | None = _AUTH_HEADER,
                vault: Vault = Depends(get_vault)) -> dict:
